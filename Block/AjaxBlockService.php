 ...
 */
class AjaxBlockService extends BaseBlockService
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new Metadata($this->getName(), ($code ?: $this->getName()), false, 'SonataDashboardBundle', array('class' => 'fa fa-dashboard'));
    }
}
